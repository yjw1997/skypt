<template>
  <div style="display :inline-block;float: left;min-height: 720px;border-right: 1px gray solid;width:100%">
    <Menu theme="light"
          style="width:100%">
      <MenuItem name="1">
    ...
    init () {
      ...
      axios({
        ...
        headers: {
          ...
          Authorization: 'Basic SlhVNFJrUTVKWFU1TVVOREpYVTJOakpHSlhVNE9UZ3hKWFUxTWtFd0pYVTFRa00ySlhVM05qZzBKWFUxTVRnMUpYVTFRa0k1SlhWR1JqQXg=',
          'Accept': '*/*',
        },
